...
-- Lain Import (Widgets and Gaps Increase)
...
beautiful.init("/home/amos/.config/awesome/themes/default/theme.lua")
...
mytextclock = wibox.widget.textclock('%I:%M %P - %a %d %b')
...
local mymem = lain.widget.mem {
    settings = function()
        widget:set_markup(mem_now.used .. "Mbs")
    end
}

-- Middle Separator
local midSep = wibox.widget {
    markup = ' | ',
    align = 'center',
    valign = 'center',
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            -- -- Crypto Price
            -- awful.widget.watch('crypto', 600),

            -- Separator
            midSep,

            -- Pacman Updates
            awful.widget.watch('pacupdates', 3600),

            -- Separator
            midSep,

            -- Pacman Updates
            awful.widget.watch('temperature', 10),
...
globalkeys = gears.table.join(
    ...
    -- Program Launchers
    awful.key({ modkey, "Shift"   }, "t", function () awful.spawn("st") end,
    ...
    awful.key({ modkey,           }, "f", function () awful.spawn("alacritty -e vifm /home/amos") end,
    ...
    -- SCREENSHOT tools
    awful.key({ modkey, "Mod1"   }, "s", function () awful.spawn("screenshot") end,
              {description = "Take a Screenshot", group = "launcher"}),
    -- Emojis
    awful.key({ modkey, "Mod1"   }, "e", function () awful.spawn("rofi -show emoji -modi emoji") end,
              {description = "Copy emoji", group = "launcher"}),
    ...
    awful.key({ modkey, "Shift"   }, "Return", function () awful.spawn("rofi -show drun -display-drun 'Run: '") end,
...
awful.rules.rules = {
    ...
    -- -- Set Spotify to always map on the tag named "7".
    -- { rule = { class = "Spotify" },
    --   properties = { tag = "8" } },
}
-- }}}
